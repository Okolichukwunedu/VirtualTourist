...
class FlickrClientUser {
    ...
    class func getPhotosFromLocation (latitude: Double, longitude: Double, completion: @escaping (FlickrResponse?, Error?)-> Void) { taskForGETRequest(url: Endpoints.getPhotos(latitude,longitude).url, responseType: FlickrResponse.self) { response, error in
